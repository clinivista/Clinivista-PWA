...
const T: Record<LangCode, AppTranslations> = {
  es: {
    ...
    pAge: "Edad", pAgePlaceholder: "Años", pCity: "Ciudad", pCityPlaceholder: "Ej. Santiago",
  ...
  en: {
    ...
    pAge: "Age", pAgePlaceholder: "Years", pCity: "City", pCityPlaceholder: "E.g. New York",
  ...
  pt: {
    ...
    pAge: "Idade", pAgePlaceholder: "Anos", pCity: "Cidade", pCityPlaceholder: "Ex. São Paulo",
  ...
  fr: {
    ...
    pAge: "Âge", pAgePlaceholder: "Ans", pCity: "Ville", pCityPlaceholder: "Ex. Paris",
  ...
  de: {
    ...
    pAge: "Alter", pAgePlaceholder: "Jahre", pCity: "Stadt", pCityPlaceholder: "z.B. Berlin",
  ...
  it: {
    ...
    pAge: "Età", pAgePlaceholder: "Anni", pCity: "Città", pCityPlaceholder: "Es. Roma",
  ...
  tr: {
    ...
    pAge: "Yaş", pAgePlaceholder: "Yıl", pCity: "Şehir", pCityPlaceholder: "Örn. İstanbul",
  ...
  ar: {
    ...
    pAge: "العمر", pAgePlaceholder: "سنة", pCity: "المدينة", pCityPlaceholder: "مثال: الرياض",
  ...
  zh: {
    ...
    pAge: "年龄", pAgePlaceholder: "岁", pCity: "城市", pCityPlaceholder: "例如：北京",
    pHairHistory: "脱发史",
