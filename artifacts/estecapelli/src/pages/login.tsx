...
export default function Login() {
  ...
  if (isLoading) return <div className="min-h-screen bg-[#0B1F33]" />;

  return (
    <div className="min-h-[100dvh] flex bg-[#0B1F33] selection:bg-primary/30">
      ...
      <div className="hidden lg:flex flex-1 relative bg-black items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 p-16 max-w-2xl w-full">
          <div className="flex items-center gap-3 mb-10">
            <div className="w-12 h-12 rounded-[12px] bg-primary flex items-center justify-center shadow-lg shadow-primary/20">
              <Activity className="w-6 h-6 text-white" />
            </div>
            <span className="text-3xl font-extrabold text-white tracking-tight">Estecapelli</span>
          </div>
          <h1 className="text-5xl font-bold text-white mb-6 leading-[1.1] tracking-tight">
            Plataforma de <br/><span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-[#3D8DFF]">Gestión Clínica</span>
          </h1>
      ...
      <div className="flex-1 flex items-center justify-center p-6 lg:p-12 relative">
        <div className="absolute inset-0 lg:hidden bg-gradient-to-br from-[#0B1F33] to-[#06121e]"></div>
        ...
        <div className="w-full max-w-md bg-white rounded-[2rem] shadow-2xl p-8 md:p-12 relative z-10 animate-in fade-in slide-in-from-bottom-8 duration-700">
          <div className="lg:hidden flex items-center justify-center gap-3 mb-10">
            ...
            <span className="text-2xl font-extrabold text-[#0B1F33] tracking-tight">Estecapelli</span>
          </div>
          ...
          <div className="flex flex-col mb-10 text-center lg:text-left">
            <div className="w-14 h-14 rounded-2xl bg-secondary flex items-center justify-center mb-6 mx-auto lg:mx-0 shadow-sm border border-gray-100">
              <Lock className="w-6 h-6 text-[#0B1F33]" />
            </div>
            <h2 className="text-2xl md:text-3xl font-bold text-[#0B1F33] tracking-tight">Bienvenido de vuelta</h2>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="space-y-3">
              <label className="text-xs font-bold text-[#0B1F33] uppercase tracking-wider ml-1">Contraseña de acceso</label>
              <Input
                type="password"
                placeholder="••••••••"
                value={password}
