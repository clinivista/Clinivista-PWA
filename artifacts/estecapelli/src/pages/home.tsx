...
export default function Home() {
  ...
  return (
    <div className="min-h-screen font-sans bg-white" dir={lang === "ar" ? "rtl" : "ltr"}>
      {/* ── Sticky Nav ─────────────────────────────────────────────────── */}
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="relative">
              <button
                ...
                className="flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-white/10 hover:bg-white/20 border border-white/20 text-white text-sm font-medium transition-colors"
              >
            ...
            <Link href="/admin/login">
              <Button size="sm" variant="outline" className="border-white/30 text-white hover:bg-white/10 hover:text-white bg-transparent text-xs px-3 h-8">
                {t.teamAccess}
              </Button>
            </Link>
          </div>
      ...
      <section className="relative min-h-[100dvh] flex items-center justify-center overflow-hidden bg-[#0B1F33]">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6 text-center pt-24 pb-16">
          ...
          <Link href="/patient">
            <Button className="h-14 px-8 text-base font-bold bg-primary hover:bg-primary/90 text-white rounded-2xl shadow-xl shadow-primary/30 group">
              {t.startCTA}
      ...
      <section className="bg-white py-24">
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-16">
            <span className="inline-block px-4 py-1.5 mb-5 rounded-full bg-[#00A9A5]/10 border border-[#00A9A5]/20 text-[#00A9A5] text-xs font-bold uppercase tracking-widest">
              {t.processLabel}
            </span>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {/* Step 1 */}
            <div className="bg-white rounded-2xl border border-gray-100 shadow-sm hover:shadow-md transition-shadow p-8 group">
              <div className="flex items-start justify-between mb-6">
                <div className="w-12 h-12 rounded-xl bg-[#00A9A5]/10 flex items-center justify-center border border-[#00A9A5]/20 group-hover:bg-[#00A9A5]/15 transition-colors">
            ...
            {/* Step 2 */}
            <div className="bg-white rounded-2xl border border-gray-100 shadow-sm hover:shadow-md transition-shadow p-8 group md:-translate-y-3">
              <div className="flex items-start justify-between mb-6">
                <div className="w-12 h-12 rounded-xl bg-[#4F9CF9]/10 flex items-center justify-center border border-[#4F9CF9]/20 group-hover:bg-[#4F9CF9]/15 transition-colors">
              ...
              <div className="flex flex-wrap gap-2">
                {t.step2Tags.map(tag => (
                  <span key={tag} className="text-xs px-2.5 py-1 rounded-full bg-[#4F9CF9]/8 border border-[#4F9CF9]/15 text-[#4F9CF9] font-medium">{tag}</span>
                ))}
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl border border-gray-100 shadow-sm hover:shadow-md transition-shadow p-8 group">
              <div className="flex items-start justify-between mb-6">
                <div className="w-12 h-12 rounded-xl bg-[#A78BFA]/10 flex items-center justify-center border border-[#A78BFA]/20 group-hover:bg-[#A78BFA]/15 transition-colors">
        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-16">
            {[t.why1, t.why2, t.why3].map((text, i) => (
              <div key={i} className="bg-white rounded-2xl p-6 shadow-sm border border-[#00A9A5]/10 flex items-start gap-4">
                <div className="w-8 h-8 rounded-full bg-[#00A9A5]/10 border border-[#00A9A5]/20 flex items-center justify-center flex-shrink-0 mt-0.5">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {[
              { value: "5", label: t.statPositions, color: "text-[#00A9A5]", bg: "bg-[#00A9A5]/8 border-[#00A9A5]/20" },
              { value: "4–6", label: t.statMinutes, color: "text-[#4F9CF9]", bg: "bg-[#4F9CF9]/8 border-[#4F9CF9]/20" },
              { value: "100%", label: t.statEncrypted, color: "text-[#A78BFA]", bg: "bg-[#A78BFA]/8 border-[#A78BFA]/20" },
              { value: "24h", label: t.statResponse, color: "text-[#F59E0B]", bg: "bg-[#F59E0B]/8 border-[#F59E0B]/20" },
            ].map(s => (
              <div key={s.label} className={`bg-white rounded-2xl p-6 text-center border ${s.bg} shadow-sm`}>
      ...
      <section className="bg-[#0B1F33] py-16">
        <div className="max-w-3xl mx-auto px-6 text-center">
          ...
          <p className="text-white/60 mb-8 leading-relaxed">{t.howSub}</p>
          <Link href="/patient">
            <Button className="h-12 px-8 text-base font-bold bg-primary hover:bg-primary/90 text-white rounded-2xl shadow-lg shadow-primary/30 group">
              {t.startCTA}
              <ArrowRight className="w-5 h-5 ml-2 group-hover:translate-x-1 transition-transform" />
            </Button>
          </Link>
