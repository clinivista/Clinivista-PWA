    ...
    <div className="min-h-[100dvh] flex flex-col bg-white font-sans selection:bg-primary/20">
      <div className="relative min-h-[100dvh] flex flex-col">
        ...
        <div className="absolute inset-0 z-0">
          <img 
            src="https://images.unsplash.com/photo-1605497788044-5a32c7078486?w=1600&q=80" 
            alt="Clínica Capilar" 
            className="w-full h-full object-cover object-center"
          />
          {/* Vibrant violet-indigo gradient overlay */}
          <div className="absolute inset-0 bg-[#1A1A2E]/80 bg-gradient-to-t from-[#1A1A2E] via-[#2D2B6B]/75 to-[#1A1A2E]/55 mix-blend-multiply"></div>
        ...
        <main className="relative z-10 flex-1 flex flex-col items-center justify-center px-6 text-center max-w-4xl mx-auto w-full pb-20">
          <div className="animate-in fade-in slide-in-from-bottom-6 duration-1000 flex flex-col items-center">
            ...
            <h1 className="text-5xl md:text-7xl font-extrabold text-white mb-8 leading-[1.1] tracking-tight">
              ...
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#A78BFA] to-[#FF6B6B]">restauración capilar</span>
            </h1>
            ...
            <Link href="/patient" className="group inline-flex items-center justify-center h-14 px-10 rounded-full bg-primary text-white text-lg font-bold hover:bg-primary/90 transition-all hover:scale-105 active:scale-95 shadow-[0_0_40px_rgba(91,76,245,0.5)] gap-3 w-full sm:w-auto">
      ...
      {/* Info Steps */}
      <div className="bg-white py-24 px-6 relative z-20 -mt-8 rounded-t-[2.5rem] shadow-[0_-20px_40px_rgba(26,26,46,0.4)]">
